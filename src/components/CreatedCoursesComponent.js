...
const CreatedCoursesComponent = ({ dataSource, setPage, setCourse }) => {
    const [loading, setLoading] = useState(true);
    const [courses, setCourses] = useState([]);

    useEffect(() => {
        dataSource.getCreatedCourses(setCourses, setLoading);
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", minWidth: "100%", alignItems: "center" }}>
            <h1 style={borderStyles}> List of courses that you have created! </h1>
